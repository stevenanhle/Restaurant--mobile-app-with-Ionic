...
.controller('AppCtrl', function($scope, $ionicModal, favoriteFactory, $timeout, $localStorage, $ionicPlatform, $cordovaCamera, $cordovaImagePicker) {
...
.controller('DishDetailController', ['$scope', '$stateParams', 'dish', '$ionicModal', '$ionicPopover', 'favoriteFactory', 'menuFactory', 'baseURL', '$ionicPlatform', '$cordovaLocalNotification', '$cordovaToast', function($scope, $stateParams, dish, $ionicModal, $ionicPopover, favoriteFactory, menuFactory, baseURL, $ionicPlatform, $cordovaLocalNotification, $cordovaToast) {
